...
import { Menu, X, Facebook, Youtube, Instagram, Music } from "lucide-react"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center">
              <div className="flex items-center justify-center w-48 h-48 rounded-full bg-black shadow-2xl">
                <img
                  src="/images/unrise-20in-20my-20life.png"
                  alt="Sunrise in my life"
                  className="h-40 w-auto filter sepia-[0.3] brightness-125 saturate-150"
                />
              </div>
            </div>

            {/* Language Toggle */}
            <div className="hidden md:flex items-center bg-gradient-to-r from-purple-100 to-teal-100 rounded-md p-1 border border-purple-300 shadow-sm">
              <button
